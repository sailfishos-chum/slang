...
# NielDK used different name.
Obsoletes:	 libslang2 < 2.3.1
...
%changelog
* Fri Apr 09 2021 Marcel Pol <marcel@timelord.nl> - 2.3.2-10
- Taken from Fedora and built on Sailfish 4.0.1.48
- Use postinstall scripts for Sailfish, not Fedora
- Disable tests (yes, I am cheap :) )
- Obsoletes libslang2 < 2.3.1 from NielDK
